    ...
    override func spec() {
        describe("url") {
            ...
            it("can match host without path") {
                let url = Url(url: NSURL(string: "http://localhost.com")! as URL, sourceApplication: nil)
            ...
            it("can match host with simple path") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo")! as URL, sourceApplication: nil)
            ...
            it("can match host with multi path") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo/bar")! as URL, sourceApplication: nil)
            ...
            it("wont match hosts with different leading paths") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo/baz")! as URL, sourceApplication: nil)
            ...
            it("can match host with multi variable path") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo/bar/baz/zoo")! as URL, sourceApplication: nil)
            ...
            it("can handle single query params") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo/bar?baz=boo")! as URL, sourceApplication: nil)
                let params = url.paramsForQueryString()
            ...
            it("can handle multi query params") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo/bar?baz=boo&zoo=fiz")! as URL, sourceApplication: nil)
                let params = url.paramsForQueryString()
            ...
            it("can handle encodings query params") {
                let url = Url(url: NSURL(string: "http://localhost.com/foo/bar?baz=hello%20world")! as URL, sourceApplication: nil)
                let params = url.paramsForQueryString()
                expect(params.count) == 1
